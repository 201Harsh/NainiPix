      ...
      <div className="relative z-10 h-full w-full justify-center flex flex-col">
        ...
        <div className="flex flex-col items-center justify-center px-4 py-8 space-y-8">
          ...
          <div className="text-center space-y-6 max-w-4xl animate-slide-up">
            <h1 className="text-4xl md:text-5xl lg:text-6xl uppercase font-Antonio font-bold text-white leading-tight">
              Create{" "}
              ...
              <br />
              with
              <span className="ml-3 text-transparent bg-clip-text bg-gradient-to-l from-emerald-400 to-sky-400">
                AI Power
              </span>
            </h1>
